...
int main()
{
    ...
    numberType *numType_Ptr[] = new int;
    numberType *numType_Ptr[0] = &zero;
    numberType *numType_Ptr[1] = &one;
    numberType *numType_Ptr[2] = &two;
    numberType *numType_Ptr[3] = &three;
    numberType *numType_Ptr[4] = &four;
    numberType *numType_Ptr[5] = &five;
    numberType *numType_Ptr[6] = &six;
    numberType *numType_Ptr[7] = &seven;
    numberType *numType_Ptr[8] = &eight;
    numberType *numType_Ptr[9] = &nine;
